...
class HAN(nn.Module):
    def __init__(
        ...
        self.han_conv = HANConv(in_channels, hidden_channels, metadata, heads)
        self.han_conv1 = HANConv(hidden_channels, hidden_channels, metadata, heads)
    ...
    def forward(self, pyg, delIndexes):
        ...
        out0 = self.han_conv1(out0, pyg.edge_index_dict)
