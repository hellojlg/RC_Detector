...
#from key2 import *RC_Detector_h
#from key1 import *RC_Detector_g
from eval import *
from genMiniGraphs import genAllMiniGraphs
import argparse

# 创建解析器
parser = argparse.ArgumentParser(description="Choose a project to run")
parser.add_argument(
    "--project",
    choices=["key1", "key2"],
    required=True,
    help="Specify which project to run"
)

args = parser.parse_args()

if args.project == "key1":
    from key1 import *
elif args.project == "key2":
    from key2 import *
